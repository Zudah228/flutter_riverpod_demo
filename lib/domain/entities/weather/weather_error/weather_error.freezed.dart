...
WeatherError _$WeatherErrorFromJson(Map<String, dynamic> json) {
  return _WeatherError.fromJson(json);
}
...
abstract class $WeatherErrorCopyWith<$Res> {
  factory $WeatherErrorCopyWith(
      ...
      _$WeatherErrorCopyWithImpl<$Res, WeatherError>;
  @useResult
  $Res call({int code, String message});
}

/// @nodoc
class _$WeatherErrorCopyWithImpl<$Res, $Val extends WeatherError>
...
class __$$WeatherErrorImplCopyWithImpl<$Res>
    extends _$WeatherErrorCopyWithImpl<$Res, _$WeatherErrorImpl>
...
/// @nodoc
@JsonSerializable()
class _$WeatherErrorImpl extends _WeatherError {
  _$WeatherErrorImpl({required this.code, required this.message}) : super._();

  factory _$WeatherErrorImpl.fromJson(Map<String, dynamic> json) =>
      _$$WeatherErrorImplFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$WeatherErrorImplToJson(
      this,
    );
  }
}

abstract class _WeatherError extends WeatherError {
  factory _WeatherError(
      {required final int code,
      required final String message}) = _$WeatherErrorImpl;
  _WeatherError._() : super._();

  factory _WeatherError.fromJson(Map<String, dynamic> json) =
      _$WeatherErrorImpl.fromJson;
